...
dependencies {
    // Compose UI 1.7+ required for androidx.compose.ui.text.TextLinkStyles (used by Markdown renderer)
    ...
    // OkHttp for ChatRepository (OpenAI API)
    implementation("com.squareup.okhttp3:okhttp:4.12.0")

    // Markdown rendering for GreenBot chat bubbles (Material 3)
